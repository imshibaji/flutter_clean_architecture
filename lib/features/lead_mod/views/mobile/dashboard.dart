        ...
        builder: (context, sp, child) {
          return SizedBox(
            ...
            child: ListView(children: [
              ...
              shortcutButton(
                title: 'All Leads',
                pins: sp.leads!.isNotEmpty ? sp.leads!.length : 0,
                onPress: () {
              ...
              shortcutButton(
                ...
                pins: sp.followups!.isNotEmpty ? sp.followups!.length : 0,
                onPress: () {
              ...
              shortcutButton(
                ...
                pins: sp.deals!.isNotEmpty ? sp.deals!.length : 0,
                onPress: () {
